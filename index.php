...
<div class="banner-top">
			<div class="social-bnr-agileits">
				<h1 style="margin-top: 10px;">DA NANG 29°C</h1>
			</div>
	 ...
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
								...
								<div class="col-md-3 price-grid">
								   <div class="price-block agile">
									   <div class="price-gd-top">
										   <a href="admin/hotel-detail-left-sidebar-deluxe.php">
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
					<div class="price-gd-top">
										   <a href="admin/hotel-detail-left-sidebar-luxury.php">
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
					<div class="price-gd-top">
										   <a href="admin/hotel-detail-left-sidebar-single.php">
				...
				<div class="col-md-3 price-grid wthree lost">
					<div class="price-block agile">
					<div class="price-gd-top">
										   <a href="admin/hotel-detail-left-sidebar-double.php">
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Quá là đẳng cấp so với những khách sạn tôi từng đến chất lượng dịch vụ khá tốt nhưng về mặt nhược điểm là bể bơi hơi nhỏ. </p>
								<h5>Hoàng  Nguyên</h5>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Giá cả vừa phải chủ nhà nghỉ rất thân thiện như người nhà. Vị tri rất thuận tiện để đi vịnh đi công viên và tắm biển.
									 Gần đây có rất nhiều quán ăn bình dân giá rẻ. Nếu mọi người ko có nhu cầu về một nơi nghỉ dưỡng sang trọng thì nên nghỉ ở đây.</p>
								<h5>Trí Thịt Bòa</h5>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Phòng sạch, vị trí khách sạn khá tiện, gần ngay phố cổ, tiện cho việc đi lại và tham quan.
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos" >
									<img style= "width: 211px; height: 159px;" src="images/teamb1.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>Địa điểm ngay gần quảng trường va đối diện có những hàng ă uống đáp ứng đc khi cần </p>
								<h5>Đăng Bảo</h5>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+84 99222-44-55</p>
