...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg   ftco-navbar-light" style=" width:105%;background-color: #0f2453 !important; top:0%;" id="ftco-navbar">
	    <div class="container" >
	      <a class="navbar-brand" href="../index.php">SUNRISE </a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="hotel-detail-left-sidebar.php" class="nav-link">Rooms</a></li>
          ...
          <div class="col-lg-8">
          	<div class="row">
          		...
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Deluxe Room <span>- (3 Available rooms)</span></h2>
    						<p>All our guestrooms are elegantly furnished with handmade furniture include luxury en-suite facilities with complimentary amenities pack, flat screen LCD TV, tea/coffee making facilities,
          ...
          <div class="col-lg-4" style="font-size: 15px; margin-bottom:25px;">
            <div class="sidebar-boxx">
              ...
              <div  style="font-size: 15px; color: #FFCE14 !important; background-color: #143a8f;color: text-item:center;text-align:center;border-radius:5px"
               class="sidebar-boxx">
								<a href="reservation.php" ><span style="color:#fcc900; font-size: 25px;" > BOOK NOW</span></a>
							</div>
            ...
            <div class="sidebar-boxx "style="margin-bottm: 20px;">
            <a href="print.php"></a>
                <h3 >Tag Cloud</h3>
              <div class="tagcloud">
